...
rng(3000, 'twister');   
synpaticEfficacies = rand(numberOfSamples, 3) .* 0.18;

parfor n = 1:numberOfSamples
  
    e2e122 = synpaticEfficacies(n, 1);
    e2i122 = e2e122;

    e2e322 = synpaticEfficacies(n, 2);
    e2i322 = e2e322;
    
    e2e123 = synpaticEfficacies(n, 3);
    e2i123 = e2e123;
    ...
    tic
    [e2eIs0, i2eIs0, eFRs0, iFRs0, x2eIs0, Ves0, Vis0, e2eIs20, i2eIs20, eFRs20, iFRs20, x2eIs20, Ves20, Vis20, e2eIs30, i2eIs30, eFRs30, iFRs30, x2eIs30, Ves30, Vis30, e2eI1220, e2iI1220, e2eI3220, e2iI3220, e2eI1230, e2iI1230] = model_3_areas_1to2_3to2_1to3(Dt, input, input2, input3, seed1, seed2, seed3, seed4, seed5, eTm, iTm, eTl, iTl, e2eTr, e2eTd, e2iTr, e2iTd,iTr, iTd, eTm2, iTm2, eTl2, iTl2, e2eTr2, e2eTd2, e2iTr2, e2iTd2,iTr2, iTd2, eTm3, iTm3, eTl3, iTl3, e2eTr3, e2eTd3, e2iTr3, e2iTd3,iTr3, iTd3, eTlinter, i2i,e2i,x2i,i2e,e2e,x2e, i2i2,e2i2,x2i2,i2e2,e2e2,x2e2, i2i3,e2i3,x2i3,i2e3,e2e3,x2e3, e2e122,e2i122,e2e322,e2i322,e2e123,e2i123,eNnrn, iNnrn);
    toc
    ...
    for i = 1:ts
        ...
        e2eI122(i)= sum(e2eI1220(1+(i-1)/dt2:i/dt2));
        e2iI122(i)= sum(e2iI1220(1+(i-1)/dt2:i/dt2));
    ...
    %%%area 2
    lfp2 = (e2eIs2+ i2eIs2 + x2eIs2 + e2eI122 + e2eI322) / (eNnrn/Dt);
    %%%area 3
...
save('./output/netsMultivariateConnection1to2and3to2and1to3count6000-rndMax0.18SynEff.mat', 'output', 'synpaticEfficacies');
