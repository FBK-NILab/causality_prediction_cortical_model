...
synpaticEfficacies = zeros(numberOfSamples, 2);
...
parfor n = 1:numberOfSamples
    ...
    tic
    [e2eIs0, i2eIs0, eFRs0, iFRs0, x2eIs0, Ves0, Vis0, e2eIs20, i2eIs20, eFRs20, iFRs20, x2eIs20, Ves20, Vis20, e2eIs30, i2eIs30, eFRs30, iFRs30, x2eIs30, Ves30, Vis30, e2eI1220, e2iI1220, e2eI3220, e2iI3220] = model_3_areas_1to2_3to2(Dt, input, input2, input3, seed1, seed2, seed3, seed4, seed5, eTm, iTm, eTl, iTl, e2eTr, e2eTd, e2iTr, e2iTd,iTr, iTd, eTm2, iTm2, eTl2, iTl2, e2eTr2, e2eTd2, e2iTr2, e2iTd2,iTr2, iTd2, eTm3, iTm3, eTl3, iTl3, e2eTr3, e2eTd3, e2iTr3, e2iTd3,iTr3, iTd3, eTlinter, i2i,e2i,x2i,i2e,e2e,x2e, i2i2,e2i2,x2i2,i2e2,e2e2,x2e2, i2i3,e2i3,x2i3,i2e3,e2e3,x2e3, e2e122,e2i122,e2e322,e2i322,eNnrn, iNnrn);
    toc
...
save('./output/netsMultivariateConnection1to2and3to2count3000-rndMax0.18SynEff.mat', 'output', 'synpaticEfficacies');
