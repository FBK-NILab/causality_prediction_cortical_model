...
synpaticEfficacies = zeros(numberOfSamples, 1);
stimulus = [ones(numberOfSamples ./ 2, 1); ones(numberOfSamples ./ 2, 1) + 1];
...
rng(1000, 'twister');   
synpaticEfficacies = rand(numberOfSamples, 1) .* 0.18;

parfor n = 1:numberOfSamples

    e2e122 = synpaticEfficacies(n);
    e2i122 = e2e122;
    ...
    tic
    [e2eIs0, i2eIs0, eFRs0, iFRs0, x2eIs0, Ves0, Vis0, e2eIs20, i2eIs20, eFRs20, iFRs20, x2eIs20, Ves20, Vis20, e2eIs30, i2eIs30, eFRs30, iFRs30, x2eIs30, Ves30, Vis30, e2eI1220, e2iI1220] = model_3_areas_1to2(Dt, input, input2, input3, seed1, seed2, seed3, seed4, seed5, eTm, iTm, eTl, iTl, e2eTr, e2eTd, e2iTr, e2iTd,iTr, iTd, eTm2, iTm2, eTl2, iTl2, e2eTr2, e2eTd2, e2iTr2, e2iTd2,iTr2, iTd2, eTm3, iTm3, eTl3, iTl3, e2eTr3, e2eTd3, e2iTr3, e2iTd3,iTr3, iTd3, eTlinter, i2i,e2i,x2i,i2e,e2e,x2e, i2i2,e2i2,x2i2,i2e2,e2e2,x2e2, i2i3,e2i3,x2i3,i2e3,e2e3,x2e3, e2e122,e2i122,eNnrn, iNnrn);
    toc
    ...
    %%%area 2
    lfp2 = (e2eIs2+ i2eIs2 + x2eIs2 + e2eI122) / (eNnrn/Dt);
    %%%area 3
    lfp3 = (e2eIs3+ i2eIs3 + x2eIs3) / (eNnrn/Dt);
...
save('./output/nets6000StimulusMaxSynEff0.181to2.mat', 'output', 'synpaticEfficacies');
